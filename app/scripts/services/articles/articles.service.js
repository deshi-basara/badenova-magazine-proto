        ...
        var service = {
            allArticles: [
                ...
                },
                {
                    ...
                    "categoryIcon": "../../images/feed/family.png" ,
                    "date": "11.05.2014",
                    "content": "Im Nordosten auf der Schwäbischen Alb liegt der Albuch, ein idealer Ort für Wintersportler. 100 Kilometer Loipen, elf Langlaufrouten, Skatingstrecken und 20 Kilometer Winterwanderwege lassen kaum Wünsche offen. <br><br>Nur rund 15 Minuten mit dem Auto von Schwäbisch Gmünd entfernt, bietet die Region um Heubach, Bartholomä, Essingen, Königsbronn und Steinheim mit ihren Hochflächen, Wäldern und Steillagen nicht nur eine schöne Landschaft, vielmehr kommen auch die Wintersportler auf ihre Kosten. Für Langläufer ist mit elf unterschiedlichen Loipen verschiedener Schwierigkeitsgrade Einiges geboten – sowohl für Freunde des klassischen Langlaufs als auch für Skater. Um 18 Uhr schließen die Loipen – die leichte, 1,2 Kilometer lange Abendloipe am Skigelände Wirtsberg in Bartholomä ist auch danach noch geöffnet. Ein Übungslift und zwei Schlepplifte, leichte bis mittelschwere Abfahrten, Flutlicht sowie Ski- und Snowboardschulen machen das Wintersportzentrum Hirtenteich besonders beliebt bei Familien. <br><br>Es ist zugleich das größte Wintersportzentrum der Region mit der längsten Abfahrtsmöglichkeit. Außerdem gibt es den Skilift am Wirtsberg, wo ab Dezember Skikurse für alle Altersklassen angeboten werden. Optimale Bedingungen für eine neuere Wintersportart, das Snow-Kiting, hat der Albuch ebenfalls. Auf der Kiting-Area bei der Lauterburg, nahe des Wintersportzentrums Hirtenteich, fliegen die Sportler dabei an einem Zugdrachen auf Ski oder Snowboard kilometerweit durch unberührten Pulverschnee. Außerdem steht in Lauterburg an der Bergrettungswache ein Eiskletterturm. Für Schneeschuhwanderer gibt es im Albuch spezielle Routen.<br><br> Die Winterwanderwege befinden sich rund um Bartholomä, Rötenbach, Gnannenweiler und das Naturschutzgebiet Wental mit seinem Felsenmeer."
                }
            ],
            teaserArticle: {
                "id": 12,
